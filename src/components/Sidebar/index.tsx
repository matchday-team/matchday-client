      ...
      <nav className={styles.nav}>
        ...
        <Link
          ...
          className={styles.navItem({
            active: currentPath === '/match/record',
          })}
        >
          <img
            src={
              currentPath === '/match/record' ? RecordBlackIcon : RecordGreyIcon
            }
            alt='Match Record'
            style={{ width: '20px', height: '20px' }}
          />
        ...
        <Link
          to='/match/search'
          className={styles.navItem({
            active: currentPath === '/match/search',
          })}
        >
          <img
            src={
              currentPath === '/match/search' ? SearchBlackIcon : SearchGreyIcon
            }
            alt='Match List'
            style={{ width: '20px', height: '20px' }}
          />
